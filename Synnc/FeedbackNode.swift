...
class FeedbackNode : CardNodeBase {
    ...
    override init() {
        ...
        feedbackArea.attributedPlaceholderText = NSAttributedString(string: "Drop us your comments.", attributes: [NSFontAttributeName : UIFont(name: "Ubuntu-Medium", size: 13)!, NSForegroundColorAttributeName : UIColor(red: 158/255, green: 158/255, blue: 158/255, alpha: 0.5), NSParagraphStyleAttributeName : p])
    ...
    override func layoutSpecThatFits(constrainedSize: ASSizeRange) -> ASLayoutSpec {
        ...
        feedbackArea.sizeRange = ASRelativeSizeRangeMakeWithExactRelativeDimensions(ASRelativeDimension(type: .Percent, value: 1), ASRelativeDimension(type: .Points, value: max(100, feedbackArea.calculatedSize.height)))
