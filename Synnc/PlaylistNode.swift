...
//    var contentHolder : ScrollContentHolder!
    ...
    override init!() {
        ...
        self.backgroundNode.backgroundColor = UIColor.SynncColor()
...
//        self.contentHolder = ScrollContentHolder()
...
//    var imageGradientNode : ASImageNode!
    ...
    override func didLoad() {
        super.didLoad()
//        
//        if let name = self.playlist!.name where self.playlist != nil {
//            self.playlistTitleNode.attributedText = NSAttributedString(string: name, attributes: (self.playlistTitleNode.typingAttributes as! [String : AnyObject]))
//        }
//        self.tracksTable.view.tableFooterView = UIView(frame: CGRectMake(0, 0, 1, 50))
