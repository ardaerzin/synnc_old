...
//        (node.mainScrollNode.backgroundNode as! PlaylistBackgroundNode).imageSelector.addTarget(self, action: #selector(PlaylistController.imageTap(_:)), forControlEvents: ASControlNodeEvent.TouchUpInside)
//        
//        node.addSongsButton.addTarget(self, action: #selector(PlaylistController.displayTrackSearch(_:)), forControlEvents: .TouchUpInside)
//        node.streamButton.addTarget(self, action: #selector(PlaylistController.streamPlaylist(_:)), forControlEvents: .TouchUpInside)
//        node.headerNode.closeButton.addTarget(self, action: #selector(PlaylistController.closeAction(_:)), forControlEvents: .TouchUpInside)
//    }
